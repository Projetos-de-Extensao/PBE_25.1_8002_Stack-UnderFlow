...
Criar um aplicativo que auxiliará os moradores da Ilha Primeira a realizar um recenso, organizando informações que não são coletadas normalmente pelo censo demográfico do IBGE. O aplicativo deverá se comunicar com uma API que armazenará os dados.
